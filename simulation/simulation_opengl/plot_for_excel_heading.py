"""  
Updated on Sun OCT 31 11:49:51 2018
...
class visualazation():
    ...
    def initialize_v_u_w(self):
        ...
        self.target_v_data=np.linspace(self.v,self.v,50)
    ...
    def init1(self):  # only required for blitting to give a clean slate.
        ...
        return [self.trajectory_line,self.line_forward_velocity,self.line_side_velocity,self.line_heading,self.line_boat,self.line_rudder,
        self.line_sail,self.line_win_boat,self.line_win_rudder,self.line_win_sail,self.line_wind,
        self.line_disired_angle,self.line_boundary,self.line_desired,self.line_target_velocity]


    def animate1(self,i):
        t=self.display_rate*i+230
        # print(t,self.table.cell(t+4,16).value,self.table.cell(t+4,17).value)
        if t%100==0:
            print(self.sail)
        # print(t,self.table.cell(t+4,14).value)
        self.get_v_u_w(t)
        self.updata_state(t)
        ...
        return [self.trajectory_line,self.line_forward_velocity,self.line_side_velocity,self.line_heading,
        self.line_boat,self.line_rudder,self.line_sail,self.line_win_boat,self.line_win_sail,self.line_target_velocity,
        self.line_win_rudder,self.line_wind,self.line_disired_angle,self.line_boundary,self.line_desired]
    ...
    def get_v_u_w(self,t):
        ...
        self.v=self.table.cell(t+4,9).value
        self.target_v=self.table.cell(t+4,18).value
        
        self.u=self.table.cell(t+4,10).value
        self.w=self.table.cell(t+4,12).value
    ...
    def updata_state(self,t):
        ...
        self.desired_angle=self.table.cell(t+4,7).value
